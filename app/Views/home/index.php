    ...
    <div class="hero-inner">
        ...
        <div class="stagger-reveal">
            ...
            <h1 class="hero-title reveal-3d">
                <?= esc(strtoupper(explode(' ', $bioName)[0] ?? 'GILANG')) ?><br>
                <span class="gradient-text">
                    <?= esc(strtoupper(implode(' ', array_slice(explode(' ', $bioName), 1)) ?: 'RIZKY')) ?>
                </span>
            </h1>
        ...
        <div class="hero-photo-wrap zoom-blur">
            ...
            <div class="hero-photo scroll-tilt parallax-wrap glass-panel-3d">
                <?php if ($bioPhoto): ?>
                    <img src="<?= esc($bioPhoto) ?>" alt="<?= esc($bioName) ?>" class="parallax-layer">
                <?php else: ?>
...
<section class="badge-section">
    <div class="badge-inner scroll-tilt">

        <!-- Left: Three.js Badge Canvas -->
        <div class="badge-canvas-wrap tilt-in-left glass-panel-3d">
            <canvas id="badge-canvas" data-photo="<?= esc($bioPhoto ?: '/assets/images/profile.jpg') ?>"></canvas>
            <div class="badge-label">
                <small>Interactive ID</small>
                <h4>DIGITAL BADGE</h4>
            </div>
        </div>

        <!-- Right: Comments -->
        <div class="comments-wrap tilt-in-right glass-panel-3d">
            ...
            <p class="comments-sub">Leave a trace of your visit below.</p>

            <!-- Form -->
            <form class="comment-form" id="comment-form" novalidate>
                <input type="text" id="comment-name" name="name" placeholder="Your Name" class="comment-input"
                    autocomplete="name">
                <div class="comment-textarea-wrap">
                    <textarea id="comment-text" name="text" placeholder="Type your message..." class="comment-textarea"
                        required></textarea>
