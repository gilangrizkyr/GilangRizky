...
<footer class="footer">
    ...
    <div class="footer-social-grid">
        <a href="<?= esc($github) ?>" class="social-3d-link github" target="_blank" rel="noopener" title="GitHub">
        ...
        <?php if ($ig): ?>
            <a href="<?= esc($ig) ?>" class="social-3d-link instagram" target="_blank" rel="noopener" title="Instagram">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path
        ...
        <?php endif; ?>
        <?php if ($email): ?>
            <a href="mailto:<?= esc($email) ?>" class="social-3d-link email" title="Email">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path
